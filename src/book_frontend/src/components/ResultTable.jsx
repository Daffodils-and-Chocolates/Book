...
import { book_backend } from "../../../declarations/book_backend";
...
export default function ResultTable(props) {
  ...
  const saveUserDataToBackend = async (userData) => {
    try {
      await book_backend.saveUser(userData.userId, userData.earnPoints);
  ...
  const fetchUsers = async () => {
    try {
      const userList = await book_backend.read();
